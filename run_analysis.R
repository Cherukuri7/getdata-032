...
# Create a master data frame from both data sets (test and train)
...
# Create data_set by subsetting only means and std dev columns from master_data for further analysis
library(dplyr)
...
# Group, summarize and arrange to create tidy_data
